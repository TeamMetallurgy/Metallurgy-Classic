        ...
        if (!state.isOf(newState.getBlock())) {
            ...
            if (blockEntity instanceof AbstractMachineEntity) {
                if (world instanceof ServerWorld) {
                    ItemScatterer.spawn(world, pos, (AbstractMachineEntity<?, ?>)blockEntity);
                    //((AbstractMachineEntity<?, ?>)blockEntity).getRecipesUsedAndDropExperience((ServerWorld)world, Vec3d.ofCenter(pos));
                }
