...
public class MetalChestEntityRenderer<T extends BlockEntity & ChestAnimationProgress> implements BlockEntityRenderer<T> {
    ...
    public MetalChestEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        BlockState blockState = worldExists ? entity.getCachedState() : MetalChestComponent.getChestBlock(MetalChestComponent.Type.BRASS).getDefaultState().with(ChestBlock.FACING, Direction.SOUTH);
        Block block = blockState.getBlock();
        if (block instanceof MetalChestBlock abstractChestBlock) {
            matrices.push();
            ...
            float g = 0;
            if (worldExists) {
                g = entity.getAnimationProgress(tickDelta);
